...
export interface ProductModifierGroupCollection {
  list(query: ListProductModifierGroupsQuery): Promise<PaginatedResultDto<ProductModifierGroupListItemDto>>
  listByProduct(query: ListProductModifierGroupsByProductQuery): Promise<PaginatedResultDto<ProductModifierGroupByProductDto>>
}
